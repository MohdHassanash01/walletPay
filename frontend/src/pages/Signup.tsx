      ...
      <div className="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8">
        ...
        <form>
          <div  className="space-y-4">
            ...
            <div>
              <label  className="text-blue-500 text-sm font-medium mb-1 block">Email Id</label>
              <input 
              ref={emailRef}
              name="email" type="email"  className="text-slate-900 bg-white border border-gray-300 w-full text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Enter email" />
                ...
                <div>
              <label  className="text-blue-500 text-sm font-medium mb-1 block">First Name...</label>
              <input 
              ref={firstNameRef}
              name="firstNmae" type="text"  className="text-slate-900 bg-white border border-gray-300 w-full text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Enter First Name" />
            </div>


                    <div>
              <label  className="text-blue-500 text-sm font-medium mb-1 block">Last Name...</label>
              <input 
              ref={lastNameRef}
              name="text" type="text"  className="text-slate-900 bg-white border border-gray-300 w-full text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Enter Last Name" />
            </div>
          ...
          <p  className="text-slate-600 text-sm mt-6 text-center">Already have an account? <Link to="/signin"  className="text-blue-600 font-medium hover:underline ml-1">Signin here</Link></p>
        </form>
